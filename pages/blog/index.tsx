...
<section >
    <div className="w-full px-5 py-6 mx-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16 max-w-7xl">
        ...
        <div className="flex flex-col items-center sm:px-5 md:flex-row">
            ...
            <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                    ...
                    <h1 className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl"><a href="#_">Ughhh seems like I haven't built it yet :(</a></h1>
      ...
      </div><div className="flex text-center justify-center"> Made with ❤   </div>
    </main>
